...
void main() {
  var values1 = [0.988, 0.978, 0.8, 0.987, 0.4, 1.9, 0.49, 0.87];
  var values2 = [
    0.678,
    0.875,
    0.536,
  ...
  group('calculateQTest', () {
    group('with confidence of 95%', () {
      test('should return a valid Q Test result when using list values1', () {
        var results = calculateQTest(values1, Confidence.percent95);
      ...
      test('should return a valid Q Test result when using list values3', () {
        var results = calculateQTest(values3, Confidence.percent95);
      ...
      test('should return a valid Q Test result when using list values5', () {
        var results = calculateQTest(values5, Confidence.percent95);
    ...
    group('with confidence of 99%', () {
      test('should return a valid Q Test result when using list values1', () {
        var results = calculateQTest(values1, Confidence.percent99);
      ...
      test('should return a valid Q Test result when using list values3', () {
        var results = calculateQTest(values3, Confidence.percent99);
      ...
      test('should return a valid Q Test result when using list values5', () {
        var results = calculateQTest(values5, Confidence.percent99);
